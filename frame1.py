...
class Frame1(QWidget):
    ...
    def btnconnect(self):
        ...
        ico_inv = QLabel()
        ico_inv.setPixmap(QPixmap(r"icons\icon11.png").scaled(20,40))
        ...
        ico_card = QLabel()
        ico_card.setPixmap(QPixmap(r"icons\19.png").scaled(30,30))
        ...
        ico_history = QLabel()
        ico_history.setPixmap(QPixmap(r"icons\20.png").scaled(30,30))
