...
class Frame1(QWidget):
    ...
    def btnconnect(self):
        ...
        w1 = QWidget()
        logo = QLabel(w1)
        logo.setPixmap(QPixmap(resource_path('icons/logo.png')).scaled(30,26))
        ...
        logow2.setPixmap(QPixmap(resource_path('icons/user_1077114.png')).scaled(24,24))
        ...
        ico_drach.setIcon(QIcon(QPixmap(resource_path('icons/home.png')).scaled(30, 30)))  # Ajout de l'icône correctement
        ...
        ico_inv.setIcon(QIcon(QPixmap(resource_path('icons/transaction.png')).scaled(30, 30)))
        ...
        ico_card.setIcon(QIcon(QPixmap(resource_path('icons/19.png')).scaled(30, 30)))
        ...
        ico_history.setIcon(QIcon(QPixmap(resource_path('icons/20.png')).scaled(30, 30)))  # Ajout de l'icône correctement
        ...
        ico_setting.setIcon(QIcon(QPixmap(resource_path('icons/22.png')).scaled(30, 30)))
        ...
        ico_exit.setIcon(QIcon(QPixmap(resource_path('icons/exit.png')).scaled(30, 30)))
    ...
    def Historique(self):
        ...
        date_icon = QLabel()
        date_icon.setPixmap(QPixmap(resource_path('icons/fleche.png')).scaled(24,24))
        ...
        notif.setIcon(QIcon(QPixmap(resource_path('icons/18.png'))))
        ...
        btn_search.setIcon(QIcon(QPixmap(resource_path('icons/icon5.png'))))
...
#########################################
    ...
    def cardpanel(self):
        ...
        iconsc = QIcon(QPixmap(resource_path('icons/add-friend_2198124.png')))
        ...
        iconcc = QIcon(QPixmap(resource_path('icons/business_16576723.png')))
        ...
        iconcc1 = QIcon(QPixmap(resource_path('icons/business_16576723.png')))
        ...
        view_mod.setPixmap(QPixmap(resource_path('icons/connection_12061681.png')).scaled(50,50))
        ...
        icop = QIcon(QPixmap(resource_path('icons/account_4291647.png')))
        ...
        puc.setPixmap(QPixmap(resource_path('icons/puce.png')).scaled(47,37))
        puc.setGeometry(45,80,47,37)

        pp = QLabel(card_view)
        pp.setPixmap(QPixmap(resource_path('icons/ppu.png')).scaled(32,32))
        ...
        lbcard2.setPixmap(QPixmap(resource_path('icons/deposit_9334619.png')).scaled(100,100))
        ...
        puce2.setPixmap(QPixmap(resource_path('icons/puce.png')).scaled(47,37))
        ...
        lbcard1.setPixmap(QPixmap(resource_path('icons/deposit_9334619.png')).scaled(100,100))
        

        ppu = QLabel(card_view1)
        ppu.setPixmap(QPixmap(resource_path('icons/ppu.png')).scaled(32,32))
    ...
    def invoivepanel(self):
        ...
        printrecharge.setStyleSheet("""
            ...
            """)
        printrecharge.setIcon(QIcon(QPixmap(resource_path('icons/printer_8139457.png'))))
        ...
        printFACTURE.setStyleSheet("""
            ...
            """)
        printFACTURE.setIcon(QIcon(QPixmap(resource_path('icons/printer_8139457.png'))))
        ...
        valide_transaction.setIcon(QIcon(QPixmap(resource_path('icons/calculator_7133722.png'))))
        ...
        vi_ic.setPixmap(QPixmap(resource_path('icons/money-transfer_9815918.png')).scaled(50,50))
        ...
        gen_card.setIcon(QIcon(QPixmap(resource_path('icons/credit-card_6296460.png'))))
...
"""
    ...
    def topcentralpan(self):
        ...
        b1 = QPushButton("")
        b1.setIcon(QIcon(QPixmap(resource_path('icons/icon1.png'))))
        b1.setStyleSheet("background-color:transparent;")
        b1.setFixedSize(36,36)
        b2 = QPushButton("")
        b2.setIcon(QIcon(QPixmap(resource_path('icons/18.png'))))
        b2.setStyleSheet("background-color:transparent;")
        b2.setFixedSize(36,36)
        b3 = QPushButton("")
        b3.setIcon(QIcon(QPixmap(resource_path('icons/icon3.png'))))
        b3.setStyleSheet("background-color:transparent;")
        b3.setFixedSize(36,36)
        b4 = QPushButton("")
        b4.setIcon(QIcon(QPixmap(resource_path('icons/icon4.png'))))
        ...
        lab_icon = QLabel()
        lab_icon.setPixmap(QPixmap(resource_path('icons/icon6.png')).scaled(16,16))
    ...
    def centrepan(self,code):
        ...
        puce1 = QLabel(card)
        puce1.setPixmap(QPixmap(resource_path('icons/puce.png')).scaled(47,37))
        ...
        ppu2 = QLabel(card2)
        ppu2.setPixmap(QPixmap(resource_path('icons/ppu.png')).scaled(32,32))
        ...
        logo.setPixmap(QPixmap(resource_path('icons/13.png')).scaled(43,27))
        ...
        logo_2.setPixmap(QPixmap(resource_path('icons/13.png')).scaled(43,27))
        ...
        factures.setPixmap(QPixmap(resource_path('icons/factures.png')).scaled(45,55))
        ...
        Commission.setPixmap(QPixmap(resource_path('icons/com.png')).scaled(45,55))
            ...
            for elmt in Historiques:
                ...
                if datetime_obj == day:
                    ...
                    if elmt["transaction_type"] == "envoie":
                        i.setPixmap(QPixmap(resource_path('icons/190.png')).scaled(20, 20))
                        j.setText("Envoie")
                        k.setText(f"+{self.deviseA} {elmt['transaction_amount']}")
                    elif elmt["transaction_type"] == "retrait":
                        i.setPixmap(QPixmap(resource_path('icons/17.png')).scaled(20, 20))
                        j.setText("Retrait")
        ...
        if Historiques is not None:  # Vérifier si la liste des historiques n'est pas vide
            for histo in Historiques:
                ...
                if histo["transaction_type"] == "envoie":
                    icon.setPixmap(QPixmap(resource_path('icons/190.png')).scaled(20,20))
                   
                if histo["transaction_type"] == "retrait":
                    icon.setPixmap(QPixmap(resource_path('icons/17.png')).scaled(20,20))
